...
folder = 'C:\Users\Alicia Rossi\Documents\Projects\AFRL\Carbon Fiber\2017-10-05 Batch #00001\';
file = 'CF_B_0deg_500um_10-5-17_.xls';
...
tnum = '09';                 % used for saving and reading the test number
...
%SearchSegEnd = 1020;                % cut off no. of data points, analyzes data up to this value 
...
[TestData, FitResults, SearchSegEnd] = Driver([folder, file], sheet, Rind, vs, seg_sizes, skip, CSM);
    % Fit Results contains all the regression analyses
    % TestData contains the raw and CSM corrected data
start = find(TestData.Data(:,3)>.8,1,'first')

% You will only see this graph if you run the code section by section
hold on
plot(TestData.Data(1:800,2), TestData.Data(1:800,3));
...
[SearchResults, npoints, HistSearchResults] = SearchExplorer(TestData, FitResults, Filt, Plastic, BEuler, bins, SearchSegEnd);
toc
...
[SearchResults, npoints, HistSearchResults] = SearchExplorer(TestData, FitResults, NewFilt, Plastic, BEuler, bins, SearchSegEnd);
